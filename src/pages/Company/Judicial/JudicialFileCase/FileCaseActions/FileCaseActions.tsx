  ...
  const { refetch } = useQuery<AxiosResponse<any, Error>>(
    ...
    },
    {
      ...
      onSuccess: (data) => {
        ...
        setValue('comercialValueSoles', data.data?.comercialValueSoles ?? 0)
        setValue('comercialValueDollars', data.data?.comercialValueDollars ?? 0)
        setValue('amountAffectionSoles', data.data?.amountAffectionSoles ?? 0)  
        setValue('amountAffectionDollars', data.data?.amountAffectionDollars ?? 0)
