...
import { createQrCode } from '@/services/judicial/judicial-file-case-related-process.service'
...
const RelatedProcessQrModal = ({ isVisible, onClose }: Props) => {
  const {
    bank: { selectedBank },
  } = useLoloContext()
...
export default RelatedProcessQrModal
