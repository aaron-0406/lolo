...
const RelatedProcessScanQrModal = ( { isVisible, onClose }: Props ) => {
  ...
  const onNavigateToFileCase = (numberCaseFile: string) => {
    console.log("numberCaseFile", numberCaseFile)
    setData(numberCaseFile)
    navigate(`${paths.judicial.detallesExpedienteRelatedProcess(customer.urlIdentifier, codeParams, numberCaseFile)}`)
  }
  return (
    <Modal
      id="judicial-related-process-scan-qr-modal"
...
export default RelatedProcessScanQrModal
