...
const JudicialCollateralFilesTable = () => {
  ...
  const [ judicialCollateralFile, setJudicialCollateralFile ] = useState<JudicialCollateralFilesType | undefined>(undefined)
  ...
  return (
    <Container width="100%" height="calc(100% - 112px)" padding="20px">
      ...
      {visibleModalCollateralFiles ? (
        <JudicialFileViewerModal isOpen={visibleModalCollateralFiles} onClose={onCloseModalCollateralFiles} file={judicialCollateralFile} />
        ) : null}
      {
        visibleModalDeleteCollateralFiles ? (
          <DeleteCollateralFilesModal id={idCollateralFile ?? 0} isOpen={visibleModalDeleteCollateralFiles} onClose={onCloseModalDeleteCollateralFiles} />
        ) : null
      }
    </Container>
  )
