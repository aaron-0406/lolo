...
const CustomersRow = (props: CustomersRowProps) => {
  ...
  return (
    <StyledContainer width="100%" height="60px" display="flex" onClick={onClickRow} gap="10px">
      <Container width="25%" height="100%" display="flex" alignItems="center" justifyContent="center">
        {code}
      </Container>
      <Container width={!isGreaterThanTableL ? '50%' : '40%'} height="100%" display="flex" alignItems="center">
