...
const ModalProductsActions = () => {
  ...
  const { isLoading: loadingCreateProduct, mutate: createProductMutate } =
  ...
  const { isLoading: loadingEditProduct, mutate: editProductMutate } =
    useMutation<any, Error>(
      async () => {
  ...
  const { isLoading: loadingDeleteProduct, mutate: deleteProductMutate } =
    useMutation<any, Error>(
      async () => {
        const { id } = getValues();
