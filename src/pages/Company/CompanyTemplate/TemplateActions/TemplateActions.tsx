  ...
  const { mutate: createTemplateHasValues } = useMutation<any, Error>(
    ...
    },
    {
      onSuccess: ({ data }) => {
        ...
        setValue("templateHasValues", [
          ...watch("templateHasValues"),
          data.template_has_values,
        ]);
  ...
  const { mutate: deleteTemplateHasValues } = useMutation<any, Error>(
    ...
    },
    {
      onSuccess: ({ data }) => {
        ...
        setValue(
          "templateHasValues",
          watch("templateHasValues").filter(
      ...
      onSuccess: ({ data }) => {
        setValue(
          ...
          watch("templateHasValues").map((item) => {
            if (item.id === data.template_has_values.id)
              return data.template_has_values;
            return item;
          })
        );
        notification({
